 ...
 */
Validators.response.lastModified = function(req, res, evaluator) {
  if (typeof evaluator.headers['last-modified'] != 'undefined')
    evaluator.flagStorable(true);
};
 ...
 */
Validators.response.eTag = function(req, res, evaluator) {
  if (typeof evaluator.headers['etag'] != 'undefined')
    evaluator.flagStorable(true);
};
